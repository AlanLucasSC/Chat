...
$a = $consulta->SELECT('mensage.id as id_mensage', 'conta', 'text', 'usuario.id as id')->FROM('mensage')->COMBINE('INNER', 'usuario', 'mensage.user_id', 'usuario.id')->WHERE('mensage.id > 201')->ORDER_BY('id_mensage', 'ASC')->FINALIZE();
var_dump($a);
echo strlen($a).' ';
$a = json_decode($a);
